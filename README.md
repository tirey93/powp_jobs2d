...
Rozwiązanie zadań laboratoryjnych zgłasza się za pomocą Pull Request (PR) oraz dodając rozwiązanie do odpowiedniej aktywności wikamp z linkiem do PR i odpowiedziami na wybrane pytania z instrukcji i diagramami UML (w postaci graficznej). 
